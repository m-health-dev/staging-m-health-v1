...
const ForbiddenContent = ({
  ...
  const logForbidden = async (geoData: any) => {
    try {
      if (hasLogged) return;

      const errorCodeNote = "401 : Unauthorized";
      const errorMessage = "Access Unauthorized";
        ...
        <div className="max-w-md">
          ...
          <div className="bg-white border p-4 rounded-3xl">
            ...
            <p className="text-sm! text-muted-foreground">
              {locale === routing.defaultLocale
                ...
                : "It seems you got lost on a wrong path."}
            </p>
          ...
          >
            ...
            <CollapsibleContent className="pt-2 text-muted-foreground space-y-1">
              ...
              <p className="text-xs!">{params.get("request")}</p>
            </CollapsibleContent>
          </Collapsible>
        </div>
      </div>
