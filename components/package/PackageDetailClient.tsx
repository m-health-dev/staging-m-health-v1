    ...
    <ContainerWrap className="grid lg:grid-cols-8 grid-cols-1 gap-5 my-20">
      ...
      <div className="lg:col-span-4">
        ...
        <Tabs
          ...
          className="w-full mt-5 border rounded-2xl md:block hidden"
        >
        ...
        <div className="flex flex-col gap-5 md:hidden mt-5">
          <div className="bg-white p-4 border rounded-2xl">
            <p className="text-sm! text-muted-foreground">{labels.medical}</p>
            <div
          ...
          <div className="bg-white p-4 border rounded-2xl">
            <p className="text-sm! text-muted-foreground">{labels.wellness}</p>
            <div
              className="prose max-w-none -my-3"
              dangerouslySetInnerHTML={{
                __html:
