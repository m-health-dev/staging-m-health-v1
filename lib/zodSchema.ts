...
export const PackageSchema = z.object({
  ...
  duration_by_day: z.number(),
  duration_by_night: z.number().optional(),
  spesific_gender: z.string().min(3),
  en_wellness_package_content: z.string().min(3),
  id_wellness_package_content: z.string().min(3),
  en_medical_package_content: z.string().min(3),
  id_medical_package_content: z.string().min(3),
  en_detail: z.string().min(3),
  id_detail: z.string().min(3),
  included: z.array(z.string()),
  vendor_id: z.string().min(3),
  hotel_id: z.string().min(3),
  real_price: z.number().min(1000),
  discount_price: z.number(),
