...
// ============================================
// Bilingual Error Messages (id = default, en = secondary)
// ============================================
type Locale = "id" | "en";
...
// Helper function to create schema based on locale
export const createZodSchemas = (locale: Locale = "id") => {
  ...
  const emailSchema = z.string().email(msg("email_invalid"));

  const AuthSignInSchema = z.object({
    email: z.string().email(msg("email_required")),
    password: z
      .string()
  ...
  const AuthSignUpSchema = z.object({
    ...
    email: z.email(msg("email_required")),
  ...
  const resetPasswordSchema = z.object({
    password: z
      .string()
      .min(8, { message: msg("password_min_8") })
      .regex(/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[\W_])[A-Za-z\d\W_]{8,}$/, {
        message: msg("password_strong"),
      }),
    confirmPassword: z
  ...
  const OTPSignInSchema = z.object({
    email: z.email(msg("email_required")),
    otp: z.string().min(6, msg("otp_required")),
  });
  ...
  const VendorSchema = z.object({
    ...
    specialist: z.array(z.string()).min(1, msg("specialist_required")),
    ...
    location_map: z.url(msg("location_map_invalid")).min(1),
  ...
  const HotelSchema = z.object({
    ...
    reference_image: z
      ...
      .min(1, msg("reference_image_min_1")),
    location_map: z.url(msg("location_map_invalid")).min(1),
    location: z.string().min(1, msg("location_required")),
  });
  ...
  const WellnessSchema = z.object({
    ...
    reference_image: z
      .array(z.string().min(1))
      .min(1, msg("reference_image_min_1")),
    duration_by_day: z.number({ message: msg("duration_day_required") }),
    duration_by_night: z.number().optional(),
    spesific_gender: z.string().min(1, msg("gender_required")),
    en_wellness_package_content: z
      .string()
      .min(1, msg("wellness_content_en_required")),
    id_wellness_package_content: z
      .string()
      .min(1, msg("wellness_content_id_required")),
    included: z.array(z.string()).min(1, msg("included_required")),
    vendor_id: z.string().min(1, msg("vendor_id_required")),
    hotel_id: z.string().optional(),
    real_price: z.number({ message: msg("real_price_required") }),
    discount_price: z.number().optional(),
    status: z.string().min(1, msg("status_required")),
  });
  ...
  const MedicalSchema = z.object({
    ...
    en_medical_package_content: z
      .string()
      .min(1, msg("medical_content_en_required")),
    id_medical_package_content: z
      .string()
      .min(1, msg("medical_content_id_required")),
    included: z.array(z.string()).min(1, msg("included_required")),
    vendor_id: z.string().min(1, msg("vendor_id_required")),
    hotel_id: z.string().optional(),
    real_price: z.number({ message: msg("real_price_required") }),
  ...
  const PackageSchema = z.object({
    ...
    duration_by_day: z.number({ message: msg("duration_day_required") }),
    duration_by_night: z.number().optional(),
    spesific_gender: z.string().min(3, msg("gender_min_3")),
    en_wellness_package_content: z
      .string()
    ...
    included: z.array(z.string()).min(1, msg("included_required")),
    vendor_id: z.string().min(3, msg("vendor_id_min_3")),
    hotel_id: z.string().min(3, msg("hotel_id_min_3")),
    real_price: z.number().min(1000, msg("real_price_min_1000")),
    discount_price: z.number().optional(),
    status: z.string().min(3, msg("status_min_3")),
  });
  ...
  const EquipmentSchema = z.object({
    ...
    reference_image: z
      .array(z.string().min(1))
      .min(1, msg("reference_image_min_1")),
    en_description: z.string().min(1, msg("description_en_min_3")),
    id_description: z.string().min(1, msg("description_id_min_3")),
    vendor_id: z.string().min(1, msg("vendor_id_required")),
    real_price: z.number({ message: msg("real_price_required") }),
    discount_price: z.number().optional(),
    status: z.string().min(1, msg("status_required")),
  ...
  const EventSchema = z.object({
    ...
    start_date: z.date({ message: msg("start_date_required") }),
    end_date: z.date({ message: msg("end_date_required") }),
    location_name: z.string().min(1, msg("location_name_required")),
    location_map: z.string().min(1, msg("location_required")),
    registration_url: z.url(msg("registration_url_invalid")).optional(),
    status: z.string().min(1, msg("status_required")),
  });
  ...
  const ArticleSchema = z.object({
    ...
    id_title: z.string().min(3, msg("title_id_min_3")),
    highlight_image: z.string().min(1, msg("highlight_image_required")),
    author: z.array(z.string().min(1)).min(1, msg("author_min_1")),
    category: z.array(z.string().min(1)).min(1, msg("category_min_1")),
    en_content: z.string().min(1, msg("content_en_required")),
    id_content: z.string().min(1, msg("content_id_required")),
    status: z.string().min(1, msg("status_required")),
  });
  ...
  const HeroSchema = z.object({
    ...
    link: z.url(msg("link_invalid")).optional(),
    display_order: z.string().min(1, msg("display_order_required")),
    is_active: z.boolean({ message: msg("is_active_required") }),
  });
  ...
  const DoctorSchema = z.object({
    ...
    specialty: z.array(z.string().min(1)).min(1, msg("specialist_min_1")),
    en_bio: z.string().min(1, msg("bio_en_required")),
    id_bio: z.string().min(1, msg("bio_id_required")),
    photo_url: z.string().min(1, msg("photo_url_required")),
    is_available: z.boolean({ message: msg("is_available_required") }),
    status: z.string().min(1, msg("status_required")),
  });
...
// ============================================
// Default exports (Indonesian - id)
// ============================================
const defaultSchemas = createZodSchemas("id");
