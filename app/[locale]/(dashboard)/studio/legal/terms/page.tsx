...
const PrivacyStudioPage = async ({
  ...
  const { data, meta, links, total } = await getAllTermsOfService(
    page,
    per_page,
    ...
    <ContainerWrap className="pb-[20vh]">
      <div className="my-10 flex items-center justify-between gap-5 sticky top-0 bg-linear-to-b from-background via-background z-20 py-5 w-full">
        <div className="flex flex-col w-full">
          <h4 className="text-primary font-semibold">Terms of Service Data</h4>
        </div>
      ...
      <p className="text-muted-foreground mb-5">
        Selalu periksa setiap melakukan pembaruan Syarat dan Ketentuan. Anda
        hanya dapat membuat/ menambahkan dan tidak dapat melakukan pembaruan/
        perubahan lagi setelah data Syarat dan Ketentuan diterbitkan. Untuk
        memperbarui anda harus membuat Syarat dan Ketentuan yang baru.
      </p>
      <div className="summary bg-white p-4 rounded-2xl border mb-4 flex flex-wrap gap-4 items-center">
        ...
        <div className="flex flex-wrap gap-4 items-center">
          <p className=" bg-teal-300 rounded-xl px-3 py-1 text-sm! w-fit">
            {total} Terms of Service Created
          </p>
        </div>
      </div>
      <Studio1DataTable
