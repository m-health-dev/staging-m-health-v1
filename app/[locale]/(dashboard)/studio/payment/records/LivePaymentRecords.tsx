...
interface LivePaymentRecordsProps {
...
const LivePaymentRecords: React.FC<LivePaymentRecordsProps> = ({
  initialData,
  meta,
  links,
  locale,
  ...
  const [data, setData] = useState<TransactionType[]>(initialData);
      ...
      intervalRef.current = setInterval(async () => {
        try {
          ...
          const res = await fetch(
            `/api/live/transaction?page=${page}&per_page=${per_page}`,
          );
          if (res.ok) {
...
export default LivePaymentRecords;
