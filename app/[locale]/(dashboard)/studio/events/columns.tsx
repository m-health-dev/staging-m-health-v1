...
export const columns: ColumnDef<VendorType>[] = [
  ...
  {
    accessorKey: "organized_image",
    enableHiding: true,
    header: ({ column }) => (
      <DataTableColumnHeader column={column} title="Org" />
    ),
    cell: ({ row }) => {
      const organized_image: string = row.getValue("organized_image");
      const organized_by: string = row.getValue("organized_by");
  ...
  },
  {
    ...
    enableHiding: true,
    header: ({ column }) => (
      <DataTableColumnHeader column={column} title="Org By." />
    ),
  },
  {
