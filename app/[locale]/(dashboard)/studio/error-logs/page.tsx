...
const ErrorLogsStudioPage = async ({
  ...
  const { data, meta, links, total } = await getAllErrorLogs(page, per_page); // nanti page bisa dynamic
    ...
    <ContainerWrap className="pb-[20vh]">
      <div className="my-10 flex items-center justify-between gap-5 sticky top-0 bg-linear-to-b from-background via-background z-20 py-5 w-full">
        <div className="flex flex-col w-full">
          <h4 className="text-primary font-semibold">Error Logs</h4>
        </div>
...
export default ErrorLogsStudioPage;
