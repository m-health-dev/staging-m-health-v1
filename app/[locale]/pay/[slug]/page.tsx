      ...
      <ContainerWrap className="my-20">
        ...
        <PaymentFlowProvider>
          <div className="grid lg:grid-cols-3 grid-cols-1 gap-10 items-start">
            <div className="col-span-2 product_information_and_booking_data">
              <div className="bg-white rounded-2xl p-5 border grid lg:grid-cols-4 grid-cols-1 gap-5">
            ...
            <PaymentSection
              ...
              realPrice={Number(data.real_price)}
              account={account}
            />
          </div>
        </PaymentFlowProvider>
